                    ...
                    <div class="col-lg-8 col-md-12 col-12">
                        ...
                        <div class="right-content">
                            <ul class="list-main">
                                ...
                                <li><i class="ti-alarm-clock"></i> <a href="{{route('products.search')}}">Search</a></li>
                                @if (Route::has('login'))
                                        @auth
                                            <li><i class="ti-user"></i> <a href="{{ url('/dashboard') }}">My account</a>
                                            </li>
                                        ...
                                        @else
                                            ...
                                            @if (Route::has('register'))
                                                <li><i class="ti-user"></i> <a href="{{ route('register') }}">My
                                                        account</a></li>
                                            @endif
                                        @endauth
                                @endif
